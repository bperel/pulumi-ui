          ...
          >
            ...
            >
              <div class="flex items-center space-x-2">
                <UIcon 
                  ...
                  :class="{ 'rotate-90': expandedProjects.has(project.name) }"
                />
            ...
            >
              <button
                ...
                :class="{ 'bg-blue-50 text-blue-600': isSelectedStack(project.name, stack.name) }"
...
const toggleProjectExpansion = (projectName: string) => {
  emit('toggle-project-expansion', projectName)
}
...
const isSelectedStack = (projectName: string, stackName: string) => {
  return props.selectedStack?.project === projectName && props.selectedStack?.name === stackName
}
</script> 